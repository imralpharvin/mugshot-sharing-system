...
presetup() {
    pushd ./chaincode/policedepartment
...
VERSION="1"
CC_SRC_PATH="./chaincode/policedepartment"
CC_NAME="policedepartment"

packageChaincode() {
    rm -rf chaincode/policedepartment/${CC_NAME}.tar.gz
    setGlobalsForPeer0Org1
    peer lifecycle chaincode package chaincode/policedepartment/${CC_NAME}.tar.gz \
...
installChaincode() {
    setGlobalsForPeer0Org1
    peer lifecycle chaincode install chaincode/policedepartment/${CC_NAME}.tar.gz
...
queryInstalled() {
    ...
    setGlobalsForPeer0Org2
    peer lifecycle chaincode queryinstalled >&chaincode/policedepartment/log.txt
    cat chaincode/policedepartment/log.txt
    PACKAGE_ID=$(sed -n "/${CC_NAME}_${VERSION}/{s/^Package ID: //; s/, Label:.*$//; p;}" chaincode/policedepartment/log.txt)
...
chaincodeInvokeInit() {
  ...
  peer chaincode invoke -o localhost:7050 \
      ...
      --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_ORG1_CA \
      --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA \
      -c '{"Args":["CreatePoliceDepartment","Guelph", "28882", "8743b52063cd84097a65d1633f5c74f5"]}'
  ...
  peer chaincode invoke -o localhost:7050 \
      ...
      --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_ORG1_CA \
      --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA \
      -c '{"Args":["CreatePoliceDepartment","Toronto", "125533", "874dwrw3b52063cd84097a65d1633f5c74f5"]}'
  ...
  peer chaincode invoke -o localhost:7050 \
      ...
      --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_ORG1_CA \
      --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA \
      -c '{"Args":["QueryPoliceDepartment", "Guelph"]}'
  ...
  peer chaincode invoke -o localhost:7050 \
      ...
      --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_ORG1_CA \
      --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA \
      -c '{"Args":["QueryPoliceDepartmentByID", "28882"]}'
  ...
  peer chaincode invoke -o localhost:7050 \
      ...
      --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_ORG1_CA \
      --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA \
      -c '{"Args":["QueryAllPoliceDepartments"]}'
